...
At the top of the inspection panel is the directories containing the file, from the root directory downwards.  You can click on a directory to navigate to that directory, and then see some accumulated statistics for that directory and it's descendents.

## Inspecting directories

Directories show less information than files - if you have git data, you will see changes by user and possibly by team.

You can also navigate to child directories - this can be handy if you can't find a directory visually.
