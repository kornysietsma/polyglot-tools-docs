...
If you are happy that the binary is safe - all the code that builds it is on github, so you should be able to inspect it yourself - you have two options to run it:

1. Add an exception - you can tell OSX it is safe by following the instructions at https://support.apple.com/en-gb/guide/mac-help/mh40616/mac
2. Remove the attribute with `xattrs`
