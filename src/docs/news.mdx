...
* Added project name, and per-run ID (usually a UUID) to the data format, mostly for user friendliness, but also so I can check when saving state in the Explorer that it relates to the correct data file
