...
Sadly the system I used to use to build the scanner binaries isn't currently working, so you need to download the code, and a rust environment, yourself.  I hope to fix this soon, at least for major platforms.

Instead you need to install rust, then compile a binary yourself - detailed instructions are [here](/tools/scanner/howto#fetching-code-and-compiling-a-binary)
